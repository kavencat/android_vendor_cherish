...
ifneq (,$(wildcard vendor/cherish/signing/keys/releasekey.pk8))
PRODUCT_DEFAULT_DEV_CERTIFICATE := vendor/cherish/signing/keys/releasekey
PRODUCT_DEFAULT_PROPERTY_OVERRIDES += ro.oem_unlock_supported=1
endif
ifneq (,$(wildcard vendor/cherish/signing/keys/otakey.x509.pem))
PRODUCT_OTA_PUBLIC_KEYS := vendor/cherish/signing/keys/otakey.x509.pem
endif
endif
...
CHERISH_DATE_HOUR := $(shell date +%H)
